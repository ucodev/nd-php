...
define('NDPHP_LANG_MOD_HELP_USERS_BRAND',						'Brand name.');
...
define('NDPHP_LANG_MOD_HELP_USERS_WEBSITE',						'The user website.');
define('NDPHP_LANG_MOD_HELP_USERS_ABOUT',						'A short about me description.');
