...
INSERT INTO `roles` VALUES (1,'ROLE_ADMIN','Administration Role',1,0),(2,'ROLE_USER_RO','Read-Only',0,0),(3,'ROLE_CUSTOM','Custom Role',0,0),(4,'ROLE_REGULAR','Regular User Role',0,0);
...
CREATE TABLE `users` (
  ...
  `generic_string_1` varchar(255) DEFAULT NULL,
  `generic_string_2` varchar(255) DEFAULT NULL,
  `generic_string_3` varchar(255) DEFAULT NULL,
  `generic_string_4` varchar(255) DEFAULT NULL,
  `generic_boolean_1` tinyint(1) DEFAULT '0',
  `generic_boolean_2` tinyint(1) DEFAULT '0',
  `generic_boolean_3` tinyint(1) DEFAULT '0',
  `generic_boolean_4` tinyint(1) DEFAULT '0',
...
INSERT INTO `users` VALUES (1,'admin','_',NULL,'your@email.address','',1,0,NULL,1,'2016-05-11 16:05:01','2030-12-31',NULL,'Admin','Admin',3,'2016-01-01',1,1,383,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2030-12-31 23:59:59','2016-05-11 16:05:01','2016-05-11 16:34:46',NULL,NULL,1,1,'2016-05-11 16:05:01',NULL,0.000000,1,NULL,'_',NULL,'2016-05-11 16:01:54',0,0,0,0,0,0,NULL,1,NULL,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,0,NULL,0,'_',1);
