...
<body class="payments_paypal_successful">
	...
	<?=filter_html(NDPHP_LANG_MOD_PAYMENT_YOUR_OF, $config['charset'])?> <?=filter_html($view['payment_amount'], $config['charset'])?> <?=filter_html($view['payment_currency'], $config['charset'])?> <?=filter_html(NDPHP_LANG_MOD_PAYMENT_IDENTIFIED_BY_TXID, $config['charset'])?> ND<?=date('Ym')?><?=filter_html($view['payment_transaction_id'], $config['charset'])?> <?=filter_html(NDPHP_LANG_MOD_PAYMENT_SUCCESSFUL_PROCESSED, $config['charset'])?>.
	<br />
	<br />
