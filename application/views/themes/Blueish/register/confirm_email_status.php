...
<body class="confirm_email_status">
<div id="confirm_email_status" class="confirm_email_status">
	<?php /* FIXME: $view['message'] contains html tags... this should not occur. Controller should send plain text and HTML should be create here in the view. */ ?>
	<?=$view['message']?>
</div>
</body>
</html>
